...
public class FortuneTellerStretchTasks {
	...
	public static void main(String[] args) {
		...
		System.out.println("Please enter your first name. You can type quit anytime to stop: ");
		...
		closeApplication(favoriteColor);

		// helps user

		// stops you from typing something other than roygbiv, help, or quit
		while (!favoriteColor.equalsIgnoreCase("red") && (!favoriteColor.equalsIgnoreCase("orange"))
				...
				&& (!favoriteColor.equalsIgnoreCase("violet")) && (favoriteColor.equalsIgnoreCase("help"))
				&& (!favoriteColor.equalsIgnoreCase("quit"))) {
			...
			while ((!favoriteColor.equalsIgnoreCase("red") && (!favoriteColor.equalsIgnoreCase("orange"))
					&& (!favoriteColor.equalsIgnoreCase("yellow")) && (!favoriteColor.equalsIgnoreCase("green"))
					&& (!favoriteColor.equalsIgnoreCase("blue")) && (!favoriteColor.equalsIgnoreCase("indigo"))
					&& (!favoriteColor.equalsIgnoreCase("violet")) && (!favoriteColor.equalsIgnoreCase("quit")))) {
				System.out.println("You did not pick a ROYGBIV Color. Please select a ROYGBIV color or help: ");
				favoriteColor = input.nextLine();
				closeApplication(favoriteColor);
			}
		...
		BigDecimal userBalance = new BigDecimal("00.00");
		if (birthMonth >= 1 && birthMonth <= 4) {
			userBalance = new BigDecimal("12.00");
		} else if (birthMonth >= 5 && birthMonth <= 8) {
			userBalance = new BigDecimal("500.23");
		} else if (birthMonth >= 9 && birthMonth <= 12) {
			userBalance = new BigDecimal("123.45");
		} else {
